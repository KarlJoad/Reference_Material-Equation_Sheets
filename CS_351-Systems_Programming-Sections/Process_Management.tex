...
\input{./CS_351-Systems_Programming-Sections/Process_Management/Terminating_Processes-exit}

\input{./CS_351-Systems_Programming-Sections/Process_Management/Get_Process_Value-wait}

\input{./CS_351-Systems_Programming-Sections/Process_Management/Change_Running_Program-exec}

\input{./CS_351-Systems_Programming-Sections/Process_Management/Signals}
