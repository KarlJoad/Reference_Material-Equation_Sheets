...
\input{./CS_351-Systems_Programming-Sections/Processes}

\input{./CS_351-Systems_Programming-Sections/Process_Management}

\input{./CS_351-Systems_Programming-Sections/IO}

\input{./CS_351-Systems_Programming-Sections/IPC}
