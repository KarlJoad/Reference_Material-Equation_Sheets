...
\begin{restatable}[Operating System]{definition}{defOperatingSystem}\label{def:Operating_System}
  ...
  This allows the OS:\@ to load \nameref{def:User} programs into \nameref{def:User}-memory, to dump for errors, to perform I/O, to \nameref{def:Context_Switch} and store the information required for such a thing, and in general, function.
\end{restatable}
