...
Because of backward compatibility with earlier UNIX and Linux versions, the default maximum value is only 32,768 (that of a \kernelinline{(short int)}), although the value can be increased as high as four million (this is controlled in \kernelinline{<linux/threads.h>}).
