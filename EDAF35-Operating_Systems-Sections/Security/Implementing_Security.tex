...
\subsubsection{Auditing, Accounting, and Logging}\label{subsubsec:Auditing_Accounting_Logging}
...
For example, all \nameref{def:System_Call} executions can be logged for analysis of program behavior.
