...
\input{./C_Primer-Sections/Intro}

\input{./C_Primer-Sections/Syntax}

\input{./C_Primer-Sections/Pointers}

\input{./C_Primer-Sections/Arrays}

\input{./C_Primer-Sections/Strings}

\input{./C_Primer-Sections/Memory_Management}

\input{./C_Primer-Sections/Composite_Data_Types}

\input{./C_Primer-Sections/Compilation}

\appendix
\input{./C_Primer-Sections/Man_Pages}
