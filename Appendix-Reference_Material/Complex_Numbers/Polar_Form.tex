...
Because exponentiation is defined to be repeated multiplication, \Cref{par:Polar_Form_Multiplication} applies.
That this generalization is true was proven by de Moiver, and is called \nameref{def:de_Moivers_Law}.

\begin{definition}[de Moiver's Law]\label{def:de_Moivers_Law}
  Given a complex number $z$, $z \in \ComplexNumbers$ and a rational number $n$, $n \in \RationalNumbers$, the exponentiation of $z^{n}$ is defined as \Cref{eq:Polar_Form_Exponentiation}.
