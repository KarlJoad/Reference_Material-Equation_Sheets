...
The term, $\ThermalVoltage$ is the \nameref{def:Thermal_Voltage}.

\begin{definition}[Thermal Voltage]\label{def:Thermal_Voltage}
  The \emph{thermal voltage}, $\ThermalVoltage$ is the voltage produced within the \PNJunction{} due to temperature.

  \begin{equation}\label{eq:Thermal_Voltage}
    \ThermalVoltage = \frac{\BoltzmannConstant \Temp}{\eCharge}
  \end{equation}
  where
  \begin{description}[noitemsep]
  \item[$\BoltzmannConstant$] Boltzmann's Constant
  \item[$\Temp$] Temperature
  \item[$\eCharge$] Charge of an electron
  \end{description}
\end{definition}
...
\subsubsection{Diffusion Current\texorpdfstring{, $\DiffusionCurrent$}{}}\label{subsubsec:pn_Junction-Diffusion_Current-No_V}
...
\subsubsection{The Drift Current\texorpdfstring{, $\DriftCurrent$}{}}\label{subsubsec:pn_Junction-Drift_Current-No_V}
...
\begin{blackbox}
  To conclude, the \PNJunction{} can conduct substantial current in the forward-bias region and the current that is allowed to flow is mostly a \nameref{def:Diffusion_Current} whose value is determined by the forward-bias voltage.
\end{blackbox}
...
\Cref{eq:pn-Junction-Current-Voltage_Relation} is usually simplified down to \Cref{eq:pn-Junction-Current-Voltage_Relation-Simple}.
...
\Cref{eq:pn-Junction-Current-Voltage_Relation} forms an exponential figure, as seen in \Cref{fig:pn-Junction-Current-Voltage_Relation}.

\begin{figure}[h!tbp]
  \centering
  \includegraphics[scale=0.75]{./pn_Junction-IV_Characteristic.png}
