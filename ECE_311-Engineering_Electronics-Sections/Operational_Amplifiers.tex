...
A figure depicting the setup of an \nameref{def:Op-Amp} that has bias currents is shown in \Cref{fig:Op-Amp_Input_Bias_Offset_Current}.

\begin{figure}[h!tbp]
  \centering
  \includegraphics[scale=0.85]{./Non-Ideal_Op-Amp-Bias_Currents.png}
