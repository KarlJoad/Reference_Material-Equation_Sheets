...
\begin{definition}[Geometric Multiplicity]\label{def:Geometric_Multiplicity}
  \emph{Geometric multiplicity} is the number of matrices required to fully identify all the \nameref{def:Eigenvector}s for a given \nameref{def:Eigenvalue}.
\end{definition}

\begin{theorem}[Geometric vs. Algebraic Multiplicity]\label{thm:Geometric_Algebraic_Multiplicity}
  The \nameref{def:Geometric_Multiplicity} of a \nameref{def:Matrix}'s \nameref{def:Eigenvector}s for a given \nameref{def:Eigenvalue} is always less than or equal to the \nameref{def:Matrix}'s \nameref{def:Characteristic_Polynomial}'s \nameref{def:Algebraic_Multiplicity}.
\end{theorem}
