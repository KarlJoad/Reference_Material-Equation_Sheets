...
\subsection{\texorpdfstring{\cinline{enum}}{\texttt{enum}}}\label{subsec:enum}
The \cinline{enum} allows us to have a set of mutually exclusive options among many.
...
An example of this datatype is shown in \Cref{lst:enum_Usage}.

\begin{listing}[h!tbp]
\csourcefile{./C_Primer-Sections/Composite_Data_Types/Code/enum.c}
\caption{\texorpdfstring{\cinline{enum}}{\texttt{enum}} Usage}
\label{lst:enum_Usage}
\end{listing}

\subsection{\texorpdfstring{\cinline{typedef}}{\texttt{typedef}}}\label{subsec:typedef}
The \cinline{typedef} keyword allows us to change the name of types.
An example of this is shown in \Cref{lst:typedef_Usage}.

\begin{listing}[h!tbp]
\csourcefile{./C_Primer-Sections/Composite_Data_Types/Code/typedef.c}
\caption{\texorpdfstring{\cinline{typedef}}{\texttt{typedef}} Usage}
