...
\newminted[assemblysource]{nasm}{
  frame=lines,
  linenos
}

\graphicspath{{./Drawings/EDAN65-Compilers}} % Uncomment this to use pictures in this document
...
\input{./EDAN65-Compilers-Sections/Introduction}

\input{./EDAN65-Compilers-Sections/Lexical_Analysis-Scanning}

\input{./EDAN65-Compilers-Sections/Syntactic_Analysis-Parsing}

\input{./EDAN65-Compilers-Sections/Abstract_Syntax_Trees}

\input{./EDAN65-Compilers-Sections/Semantic_Analysis}

\input{./EDAN65-Compilers-Sections/Reference_Attribute_Grammars}

\input{./EDAN65-Compilers-Sections/Runtime_Systems}

\input{./EDAN65-Compilers-Sections/Code_Generation}
%====================================APPENDIX====================================
\appendix
