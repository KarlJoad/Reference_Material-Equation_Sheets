...
Refer to \Cref{subsubsec:Z-Transform Time Shifting}, \nameref{subsubsec:Z-Transform Time Shifting} for greater explanation.
Since there are many similarities between the \nameref{def:Z-Transform} and the \nameref{def:Discrete-Time_Fourier_Transform}, the explanation holds, so long as you keep $z=e^{-j 2\pi ft}$ in mind.
