...
The \nameref{def:Discrete-Time_Fourier_Transform} can be viewed as the $\ZTransform$-transform at of the sequence evaluated at the unit circle.
...
\begin{blackbox}
  The existece of the $\ZTransform$-transform requires that \Cref{eq:ZTransform_DTFT_Existence_Requirement} be satisfied for some region in the $z$-plane.
