...
These are usually found by sampling analog signals or \nameref{subsec:Continuous-Time Signals}.
There are 2 ways to express this, both are shown in \Cref{eq:A_D_By_Sampling}.
