...
\begin{propertylist}
\item \nameref{subsubsec:Z-Transform Linearity}
\item \nameref{subsubsec:Z-Transform Time Shifting}
\item \nameref{subsubsec:Z-Domain Scaling}
\item \nameref{subsubsec:Z-Transform Time Reversal}
\item \nameref{subsubsec:Z-Domain Differentiation}
\item \nameref{subsubsec:Z-Domain Convolutions}
\item \nameref{subsubsec:Z-Transform 2 Sequence Correlation}
\item \nameref{subsubsec:Z-Transform 2 Sequence Multiplication}
\item \nameref{subsubsec:Parsevals Relation for Z-Transform}
...
\subsubsection{Z-Transform Linearity}\label{subsubsec:Z-Transform Linearity}
If
\begin{equation*}
  \begin{aligned}
...
\end{equation*}
then
\begin{equation}\label{eq:Z-Transform Z-Transform Linearity}
...
\begin{example}[Example 3.2.1]{Simple Z-Transform Linearity Problem}
...
\begin{example}[Example 3.2.2]{Z-Transform Linearity on Trig Functions}
...
\subsubsection{Z-Transform Time Shifting}\label{subsubsec:Z-Transform Time Shifting}
If
\begin{equation*}
  x(n) \ZTransformRelation X(z)
\end{equation*}
...
\begin{example}[Example 3.2.3]{Z-Transform Time Shifting}
...
\subsubsection{Z-Transform Time Reversal}\label{subsubsec:Z-Transform Time Reversal}
If
\begin{equation*}
  x(n) \ZTransformRelation X(z), \> \ROC: r_{1}< \lvert z \rvert < r_{2}
\end{equation*}
...
\begin{example}[Example 3.2.6]{Z-Transform Time Reversal}
  Determine the $z$-transform of the signal
  \begin{equation*}
    x(n) = \UnitStep(-n)
  \end{equation*}
...
\begin{example}[Example 3.2.7]{Z-Domain Differentiation}
  Determine the $z$-transform of the signal
  \begin{equation*}
    x(n) = na^{n}\UnitStep(n)
  \end{equation*}
...
\begin{example}[Example 3.2.9]{Z-Domain Convolutions}
...
\subsubsection{Z-Transform 2 Sequence Correlation}\label{subsubsec:Z-Transform 2 Sequence Correlation}
If
\begin{equation*}
  \begin{aligned}
    x_{1}(n) &\ZTransformRelation X_{1}(z) \\
...
\begin{example}[Example 3.2.10]{Z-Transform 2 Sequence Correlation}
...
\subsubsection{Z-Transform 2 Sequence Multiplication}\label{subsubsec:Z-Transform 2 Sequence Multiplication}
If
\begin{equation*}
  \begin{aligned}
    x_{1}(n) &\ZTransformRelation X_{1}(z) \\
...
\subsubsection{Parsevals Relation for Z-Transform}\label{subsubsec:Parsevals Relation for Z-Transform}
...
\subsection{Common \texorpdfstring{$Z$-Transforms}{Z-Transforms}}\label{subsubsec:Common Z-Transforms}
\begin{table}[h!]
  \centering
  \begin{tabular}{cc}
    \toprule \\
