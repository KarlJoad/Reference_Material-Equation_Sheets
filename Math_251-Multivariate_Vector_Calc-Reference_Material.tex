...
\DeclareMathOperator{\projection}{\text{proj}}
\DeclareMathOperator{\cross}{\times}

\begin{titlepage}
  \title{Math 251: Multivariate and Vector Calculus --- Reference Material \\ Illinois Institute of Technology}
  \author{Karl Hallsby}
...
\input{./Math_251-Multivariate_Vector_Calc-Sections/Intro}
