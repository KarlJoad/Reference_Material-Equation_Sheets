...
\usepackage{xcolor} % Gives access to coloring text in environments or just text
...
% Since Lemmas are based off the Theorem environment, they are automatically numbered with section numbers
\newtheorem{lemma}[theorem]{Lemma}

% Create a special list that handles properties. It can be broken and restarted
\newlist{propertylist}{enumerate}{1} % {Name}{Template}{Max Depth}
\setlist[propertylist, 1]{label=\textbf{(\roman*)}, ref=\textbf{(\roman*)}, noitemsep, nolistsep} % Set options
