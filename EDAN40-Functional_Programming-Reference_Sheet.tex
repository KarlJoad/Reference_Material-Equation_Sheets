...
\input{./EDAN40-Functional_Programming-Sections/Introduction}

\input{./EDAN40-Functional_Programming-Sections/Constructing_Functions}

\input{./EDAN40-Functional_Programming-Sections/List_Comprehensions}

\input{./EDAN40-Functional_Programming-Sections/Recursion}

\input{./EDAN40-Functional_Programming-Sections/Types_Typeclasses}

\input{./EDAN40-Functional_Programming-Sections/Higher_Order_Functions}

\input{./EDAN40-Functional_Programming-Sections/Declaring_Types}

\input{./EDAN40-Functional_Programming-Sections/Monads}

\input{./EDAN40-Functional_Programming-Sections/Lazy_Evaluation}

\input{./EDAN40-Functional_Programming-Sections/Lambda_Calculus}
