...
\end{enumerate}
	...
	\subsection{Conditional Probability} \label{subsec:Conditional Probability}
		...
		\begin{definition}[Baye's Rule] \label{def:Baye's Rule}
			...
			\end{equation}
		\end{definition}
		\begin{tcolorbox}[title=\textbf{\nameref{def:Baye's Rule} Example}, colbacktitle=white!100!black, coltitle=black!100!white, colback=white!100!black, sharp corners=all] \label{ex:Baye's Rule}
			An urn with 5 balls, identical  in every way, except that 2 are red and 3 are green.
			You select two balls at random, without replacement and record the sequence of colors you observed.
			What is probability that the first ball was green given that the second was green?
		\end{tcolorbox}
