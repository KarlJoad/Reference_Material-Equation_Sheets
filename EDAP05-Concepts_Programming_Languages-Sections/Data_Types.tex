...
Lists in Scheme, LISP, and Common LISP can be considered linked-lists.
...
\begin{definition}[List Comprehension]\label{def:List_Comprehension}
  ...
  Essentially, a list comprehension applies a function to every element in a given array/\nameref{def:List}, and a new array/\nameref{def:List} is constructed from the results.
