...
% NAME is mandatory, but neither can have commas in it.
...
\DeclareMathOperator{\DiffD}{\mathrm{d}} % Used for differentiation fractions
...
\DeclareMathOperator{\ZTransform}{Z}
