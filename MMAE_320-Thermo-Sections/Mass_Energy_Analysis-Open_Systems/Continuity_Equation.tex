...
\begin{example}[Textbook Problem 6.7]{Flow with Changing Mass Density}
  ...
  This is a steady flow problem, meaning we can use the \nameref{def:Continuity_Equation} freely.
