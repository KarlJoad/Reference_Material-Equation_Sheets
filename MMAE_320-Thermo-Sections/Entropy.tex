...
If a \nameref{def:Process} involving an ideal gas is \nameref{def:Isentropic}, then it behaves according to a set of interesting equations (\Crefrange{subeq:Isentropic_Ideal_Gas-Pressure_Volume}{subeq:Isentropic_Ideal_Gas-Temperature_Pressure}).
...
\Crefrange{subeq:Isentropic_Ideal_Gas-Pressure_Volume}{subeq:Isentropic_Ideal_Gas-Temperature_Pressure} all have a $k$ value defined as:
\begin{equation*}
  k = \frac{\SpecificHeatPressure}{\SpecificHeatVolume}
\end{equation*}

\subsubsection{Variable \nameref*{def:Specific_Heat}s}\label{subsubsec:Variable_Specific_Heats}
