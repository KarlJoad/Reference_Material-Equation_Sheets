...
\newcommand{\SaturatedFluidVol}{\ensuremath{\Volume_{F}}} % Can be V_{Fluid}
\newcommand{\SaturatedVaporVol}{\ensuremath{\Volume_{G}}} % Can be V_{Vapor} or V_{Gas}
\newcommand{\AvgSpecificVol}{\ensuremath{\nu_{Avg}}}
