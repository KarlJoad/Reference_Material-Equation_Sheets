\documentclass[answers]{exam} % answers ensures that answers are printed for each question.
...
\input{./EITP20-Secure_Systems_Engineering-Study_Questions_Sections/Security_Design}

\input{./EITP20-Secure_Systems_Engineering-Study_Questions_Sections/Security_Evaluation}

\input{./EITP20-Secure_Systems_Engineering-Study_Questions_Sections/Protocol_Analysis}
