	...
	\subsection*{Laplace Transform Properties} \label{subsec:Laplace Transform Properties}
		...
		\begin{table}[h!]
			...
			\begin{tabular}{|l|c|c|}
				...
				Initial Value Theorem & \multicolumn{2}{c|}{$x \left( 0^{+} \right) = \lim\limits_{s \to \infty} sX(s)$} \\ \hline
				Final Value Theorem & \multicolumn{2}{c|}{$\lim\limits_{t \to \infty} x(t) = \lim\limits_{s\to 0} sX(s)$} \\ \hline
