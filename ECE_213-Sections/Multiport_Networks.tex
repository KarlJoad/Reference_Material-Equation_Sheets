...
Multiple \nameref{sec:Multiport Networks} can be arranged in 3 ways:
	...
	\subsection*{Transistors}
		\begin{align*}
			...
			I_{B} &= \frac{h_{oe}\left( 1 + h_{oe}R_{L} \right)}{-h_{oe}R_{L}} V_{C} & V_{B} &= \frac{h_{ie}+\left( h_{ie}h_{oe} + h_{ie}h_{fe} \right)R_{L}}{h_{fe}R_{L}} \\ \hline
			A_{V} &= \frac{V_{C}}{V_{B}} & A_{I} &= \frac{I_{C}}{I_{B}} \\
